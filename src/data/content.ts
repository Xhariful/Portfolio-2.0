...
export const initialPortfolioData: PortfolioData = {
  ...
  certifications: [
    {
      id: "cert-1",
      title: "Shopify Partner & Liquid Theme Specialist",
      org: "Shopify Official Partner Academy",
      date: "2023 - Present",
      credentialId: "SHP-9921-VERIFIED",
      credentialUrl: "https://www.shopify.com/partners",
      category: "E-Commerce",
      description: "Advanced certification covering Shopify 2.0 theme architecture, custom Liquid templating, Storefront APIs, and checkout optimizations.",
      skills: ["Shopify Liquid", "Theme Architecture", "Storefront API", "Speed Optimization"],
    },
    {
      id: "cert-2",
      title: "Python & Django Scalable Web Architecture",
      org: "Professional Software Institute",
      date: "2023",
      credentialId: "PY-DNG-44-ARCH",
      credentialUrl: "https://www.djangoproject.com",
      category: "Backend & Systems",
      description: "Mastery of relational database modeling with PostgreSQL, Celery asynchronous pipelines, RESTful APIs, and cloud deployments.",
      skills: ["Python", "Django REST", "PostgreSQL", "API Security"],
    },
    {
      id: "cert-3",
      title: "Modern React.js & Frontend Engineering Architecture",
      org: "Web Development Academy",
      date: "2022",
      credentialId: "DEV-ADV-78-REACT",
      credentialUrl: "https://react.dev",
      category: "Frontend",
      description: "Certification in modern state management, component lifecycle, Next.js hybrid rendering, and Tailwind CSS responsive design systems.",
      skills: ["React.js", "TypeScript", "Tailwind CSS", "Next.js"],
    },
    {
      id: "cert-4",
      title: "Certified Full-Stack Software Engineering",
      org: "Interactive Cares Technical Institute",
      date: "2021",
      credentialId: "IC-FS-2021-HONORS",
      credentialUrl: "https://interactivecares.com",
      category: "Software Engineering",
      description: "Comprehensive software engineering program focused on algorithms, scalable web portals, team leadership, and CI/CD pipelines.",
      skills: ["Full-Stack Dev", "Git & CI/CD", "Database Design", "Agile Leadership"],
    },
  ],
  ...
  testimonials: [
    {
      ...
      company: "Aura Apparel, London, UK",
      project: "Custom Shopify 2.0 Theme Rebuild",
      rating: 5,
      date: "2024",
    },
    {
      ...
      company: "Nordic Data Tech, Paris, France",
      project: "Automated Data Scraping & Pipeline",
      rating: 5,
      date: "2024",
    },
    {
      id: "test-3",
      quote:
        "Outstanding attention to detail. Every pixel from our Figma design matched perfectly, and the mobile responsiveness was completely flawless.",
      name: "Sarah Jenkins",
      role: "Creative Agency Lead",
      company: "Apex Studio, California, USA",
      project: "Figma to Interactive Web Application",
      rating: 5,
      date: "2023",
    },
  ],
