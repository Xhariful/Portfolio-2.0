          ...
          <div className="animate-marquee-left flex gap-3.5 pr-3.5">
            {[...row1Skills, ...row1Skills].map((skill, idx) => (
              <div
                ...
                className="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-white/45 dark:bg-zinc-900/45 backdrop-blur-md border border-slate-200/70 dark:border-zinc-800/70 shadow-xs hover:shadow-md hover:border-purple-400 dark:hover:border-purple-600 transition-all duration-200 select-none group flex-shrink-0 cursor-default"
              >
                <div
