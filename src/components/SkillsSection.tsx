    ...
    <section id="skills" className="py-24 px-4 sm:px-6 lg:px-8 relative border-t border-slate-200/60 dark:border-zinc-800/60 bg-slate-50/20 dark:bg-zinc-950/20 scroll-mt-24">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-sky-500/20 bg-sky-500/10 backdrop-blur-xs text-sky-700 dark:text-sky-300 text-xs font-mono">
