...
export const Footer: React.FC<{ onNavigate: (sectionId: string) => void }> = ({ onNavigate }) => {
  ...
  return (
    <footer className="relative border-t border-slate-200 dark:border-zinc-800/80 bg-slate-50/70 dark:bg-zinc-950 pt-16 pb-12 px-4 sm:px-6 lg:px-8 overflow-hidden text-slate-600 dark:text-zinc-400">
      ...
      <div className="max-w-7xl mx-auto space-y-12 relative z-10">
        ...
        <div className="rounded-3xl p-6 sm:p-8 bg-white dark:bg-zinc-900/90 border border-slate-200/90 dark:border-zinc-800 shadow-xl shadow-slate-200/40 dark:shadow-none">
          <div className="grid lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-3">
              <div className="flex flex-wrap items-center gap-2.5">
                ...
                {currentTime && (
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-mono text-slate-500 dark:text-zinc-400 bg-slate-100 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700/60">
            ...
            <div className="lg:col-span-5 flex flex-col sm:flex-row items-stretch sm:items-center justify-start lg:justify-end gap-3">
              <button
                onClick={copyEmail}
                className="px-5 py-3 rounded-xl bg-purple-600 hover:bg-purple-700 text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all cursor-pointer"
              >
              ...
              {profile.socials?.whatsapp && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-5 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 shadow-md transition-all cursor-pointer"
                >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10 pt-4">
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <div className="flex flex-wrap gap-1.5 text-[11px] font-mono">
              <span className="px-2 py-1 rounded-md bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-slate-700 dark:text-zinc-300">Shopify 2.0</span>
              <span className="px-2 py-1 rounded-md bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-slate-700 dark:text-zinc-300">Liquid</span>
              <span className="px-2 py-1 rounded-md bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-slate-700 dark:text-zinc-300">Python</span>
              <span className="px-2 py-1 rounded-md bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-slate-700 dark:text-zinc-300">Django REST</span>
              <span className="px-2 py-1 rounded-md bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-slate-700 dark:text-zinc-300">React.js</span>
              <span className="px-2 py-1 rounded-md bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-slate-700 dark:text-zinc-300">Next.js</span>
              <span className="px-2 py-1 rounded-md bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-slate-700 dark:text-zinc-300">Tailwind CSS</span>
              <span className="px-2 py-1 rounded-md bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-slate-700 dark:text-zinc-300">PostgreSQL</span>
            </div>
          </div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              {profile.socials?.github && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-2.5 rounded-xl bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-slate-700 dark:text-zinc-300 hover:text-purple-600 dark:hover:text-white hover:border-purple-400 dark:hover:border-purple-600 transition-all cursor-pointer shadow-sm"
                  title="GitHub"
                >
              ...
              {profile.socials?.whatsapp && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-2.5 rounded-xl bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-slate-700 dark:text-zinc-300 hover:text-emerald-600 dark:hover:text-emerald-400 hover:border-emerald-400 transition-all cursor-pointer shadow-sm"
                  title="WhatsApp"
                >
                  <MessageSquare className="w-4 h-4" />
                </a>
