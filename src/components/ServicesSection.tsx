        ...
        <div className="grid md:grid-cols-2 gap-6">
          {displayedServices.map((service, idx) => (
            <motion.div
              ...
              className="p-7 rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 hover:border-purple-400 dark:hover:border-purple-600 transition-all space-y-5 flex flex-col justify-between shadow-sm dark:shadow-none"
            >
