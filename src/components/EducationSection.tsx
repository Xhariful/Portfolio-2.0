      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <p className="text-base text-slate-600 dark:text-zinc-400">
            Educational foundation, engineering degrees, and professional credentials shaping my technical expertise.
          </p>
        </div>
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 space-y-6 shadow-sm dark:shadow-none">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-zinc-800 pb-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">Professional Certifications & Badges</h3>
                <p className="text-xs text-slate-500 dark:text-zinc-400">Industry-recognized verifications and specialized certifications</p>
              </div>
            </div>

            <button
              onClick={openAdminPortal}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-100 dark:bg-zinc-800 hover:bg-slate-200 dark:hover:bg-zinc-700 text-slate-800 dark:text-zinc-200 text-xs font-semibold cursor-pointer transition-colors w-fit"
            >
            ...
            {certifications.map((cert, idx) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-mono text-slate-500 dark:text-zinc-500">{cert.date}</span>
                </div>
                <h4 className="text-sm font-bold text-slate-900 dark:text-white">{cert.title}</h4>
                <p className="text-xs text-slate-600 dark:text-zinc-400 font-medium">{cert.org}</p>
              </div>
            ))}
          </div>
        </div>
