    ...
    <section id="hero" className="relative min-h-[90vh] flex flex-col justify-center pt-28 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 space-y-16">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          {/* Right Column: Clean Profile Showcase Card (5 Cols) */}
            ...
            {stats.map((item, idx) => (
              ...
              >
                <div className="flex items-baseline gap-1">
                  ...
                  <span className="text-2xl font-bold text-purple-600 dark:text-purple-400">{item.suffix}</span>
                </div>
...
const CleanSocialLink = ({ href, icon, label }: { href: string; icon: React.ReactNode; label: string }) => (
  <a
    ...
    rel="noreferrer"
    aria-label={label}
    className="p-2 rounded-xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-slate-600 dark:text-zinc-400 hover:text-purple-600 dark:hover:text-purple-300 hover:border-purple-400 dark:hover:border-purple-600 transition-all cursor-pointer shadow-sm"
    title={label}
  >
    {icon}
  </a>
