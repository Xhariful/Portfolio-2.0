                          ...
                          {project.githubUrl && (
                            <Magnetic strength={0.4}>
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="p-2 rounded-lg bg-slate-100/70 dark:bg-zinc-950/60 backdrop-blur-xs hover:bg-slate-200 dark:hover:bg-zinc-800 border border-slate-200/80 dark:border-zinc-800/80 text-slate-600 dark:text-zinc-400 hover:text-slate-900 dark:hover:text-white transition-colors cursor-pointer block"
                                title="GitHub Source"
                              >
